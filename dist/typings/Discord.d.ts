...
import types, { APIGuild, Snowflake } from "discord-api-types/v9";
 ...
 */
export declare type CachedGuild = Omit<APIGuild, "channels" | "roles" | "members" | "presences">;
export declare type CachedChannel = APIChannel & {
    guild_id: Snowflake;
};
export declare type EventedGuild = DiscordEventMap["GUILD_CREATE"];
